<!DOCTYPE html>
    ...
    $query = "SELECT * FROM vehiclesType WHERE name LIKE :searchContent";
                ...
                <?php while ($row = $stmt->fetch()) { ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td class="px-6 py-2 font-bold text-gray-900 dark:text-white">
                                    <?php echo $row->vehiclesTypeID; ?>
                                </td>
                                <td class="px-6 py-2 font-bold text-gray-900 dark:text-white">
                                    <?php echo $row->name; ?>
                                </td>
                                <td class="px-6 py-2">
                                    <a href="../vehiclesType/editVehicleType.php?id=<?php echo $row->vehiclesTypeID ?>">
