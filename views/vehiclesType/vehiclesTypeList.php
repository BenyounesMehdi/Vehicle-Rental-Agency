...
<p class="mb-3 text-2xl font-semibold text-gray-900 dark:text-white">Vehicles Type List</p>
    ...
    <div class="px-2 sm:px-16">
        ...
        <div id="vehiclesTypeList" class="relative overflow-x-auto shadow-lg mt-3"">
...
<?php } ?>
    ...
    // require_once '../../models/database.php' ;
        ...
        $vehiclesType = $stmt->fetchAll(); // Fetch all rows from the result set 
        ?>
    <div id="vehiclesTypeTable" class="relative overflow-x-auto overflow-y-auto shadow-lg mt-3" style="max-height : 350px;">
                        ...
                        foreach ($vehiclesType as $vehicleType) { ?> 
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td class="px-6 py-2 font-bold text-gray-900 dark:text-white">
                                    <?php echo $vehicleType->vehiclesTypeID; ?>
                                </td>
                                <td class="px-6 py-2 font-bold text-gray-900 dark:text-white">
                                    <?php echo $vehicleType->name; ?>
                                </td>
                                <td class="px-6 py-2">
                                    <a href="../vehiclesType/editVehicleType.php?id=<?php echo $vehicleType->vehiclesTypeID ?>">
