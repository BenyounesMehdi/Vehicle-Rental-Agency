...
<div class="bg-gray-900 dark:bg-gray-600 w-1/2 px-2 py-3 rounded-lg">
    <div class="flex items-center justify-between mb-2">
            <p class="text-white text-4xl font-semibold ml-2">Ratings</p>
        ...
        <p class="text-sm font-medium text-gray-500 dark:text-gray-400"><?php echo $totalOpinions; ?> global ratings</p>

        <div class="flex flex-col justify-start items-center mt-1 mb-2">
