...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <div>
        ...
        <div class="relative h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul class="space-y-2 font-medium" id="sideBar">
                <li>
        ...
        <div class="p-4 sm:ml-64" id="content-container">
            <?php   
                // Check if the current URL path matches the dashboard path
                $currentURL = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
                $urlComponents = parse_url($currentURL);
                $path = $urlComponents['path'] ;
                // echo $path ;

                // If the current path matches the dashboard path, include the dashboardSide content
                if($path == "/VehicleRentalAgency/views/admin/dashboard.php") {
                    include ('dashboardSide.php');
                }
            ?>
        </div>
