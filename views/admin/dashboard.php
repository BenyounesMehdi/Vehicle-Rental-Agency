...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <div>
        ...
        <div class="relative h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul class="space-y-2 font-medium ">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg focus:bg-red-500 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li class="flex">
                    <a href="#" class="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <i class="fa-sharp fa-solid fa-car text-gray-500 text-xl"></i>
                    <span class="ms-3 whitespace-nowrap">Vehicles</span>
                    </a>
                </li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <i class="fa-regular fa-steering-wheel flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-white group-hover:text-gray-900 dark:group-hover:text-white"></i>
                    <span class="ms-3 whitespace-nowrap">Brands</span>
                    </a>
                </li>
                <li>
                    <button id="theme-toggle" type="button" class="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li class="absolute bottom-2" style="width: 90%;">
                    <a href="./signOut.php" class="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <div class="p-4 sm:ml-64">
            <?php 
                ...
                // if( $path == "/VEhicleRentalAgency/views/admin/clientSide.php" ) {
    ...
    <script>
        function themeToggle() {
            var themeExepression = document.getElementById("themeExepression");
